...
4.  **Schema Enforcement:** The model is constrained to output **only** valid JSON. This ensures the frontend can reliably parse the data into the UI components (Summary and Lists) without hallucinated formatting.
